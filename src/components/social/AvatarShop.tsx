      ...
      <div className="bg-gradient-to-br from-fingo-green-soft via-white to-fingo-blue-soft px-5 py-5 sm:px-6">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center">
          ...
          <div className="flex-1">
            <div className="mb-2 inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-bold text-fingo-green-dark shadow-sm">
              <Icon name="face" className="text-[1.1rem]" />
              Your FinGo avatar
            </div>
            <h2 className="font-display text-2xl font-extrabold text-fingo-ink">Avatar shop</h2>
            <p className="mt-1 max-w-xl text-sm text-fingo-muted">
              Earn points by completing savings goals, then spend them on cute accessories.
            </p>
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <div className="inline-flex items-center gap-2 rounded-2xl bg-amber-100 px-4 py-2 font-display font-bold text-amber-800">
      ...
      <div className="space-y-4 p-5 sm:p-6">
        {(lastPointsEarned || notice || error) && (
          <div className="space-y-2">
            ...
            {error && <div className="rounded-2xl bg-red-50 px-4 py-2 text-sm font-semibold text-red-600">{error}</div>}
          </div>
        )}
